...
⠀⡸⠁⠀⠀⢀⣾⢧⡀⠀⠛⣶⠦⠤⡼⠿⣤⠎⠀⣰⠃⠀⠀⠁⠀⠀⠀⢱⠀⡰⠁⠀⠀⠀⠀⠀⠀⢘⣆`))
  console.log(
    color(
      figlet.textSync("Letih-Ai V 1.0.0", {
        font: "Standard",
...
return {
conversation: 'WhatsApp Bot By kalz'
}}
}
const client = func.makeWASocket(connectionOptions)
...
console.log(`${chalk.redBright('Your Pairing Code =>')} : ${code}`)
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      console.log(color("Tolong Jangan Salah Gunakan Bot Ini, Terimakasih 🙏🏻", "Blue"));
